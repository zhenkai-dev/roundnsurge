...
@section('listing')
    ...
    @component('admin.shared.listing.listing-header-component', ['module' => \App\Menu::class])
    ...
    @if (count($menus))
        <div class="dd" id="nestable">
            @include('admin.menu.list.item', ['allMenu' => $menus, 'menus' => $menus[0]])
        </div>
    @else
    ...
    <script>
        $(document).ready(function() {
            var updateOutput = function (e) {
                ...
                $.ajax({
                    type: 'PUT', url: '{{ route('admin.menu.sortable') }}', dataType: 'json', data: param,
