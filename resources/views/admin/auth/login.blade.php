...
<form class="form-horizontal form-validation" method="POST" action="{{ route('admin.login') }}">
    {{ csrf_field() }}
    ...
    <div class="row">
        ...
        <div class="col-6 text-right d-none">
            <a class="btn btn-link px-0" href="{{ route('admin.password.request') }}">{{ __('auth.forgot') }}</a>
        </div>
    </div>
</form>
@endsection
