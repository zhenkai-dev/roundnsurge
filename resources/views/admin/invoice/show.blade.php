...
@section('show')
    ...
    <div class="row">
        ...
        <div class="col-sm-6 text-right">
            <h1 class="custom-h1">{{ __('invoice.invoice') }}</h1>
        </div>
    </div>
    ...
    <div class="u-row-container mt-5" style="padding: 0px;background-color: transparent;overflow-x:auto;">
            ...
            <div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                <div class="u-col u-col-66p83" style="max-width: 290px;min-width: 300px;display: table-cell;vertical-align: top;">
                    <div style="background-color: #c2e0f4;width: 100% !important;">
                        <div id="responsive-notes" style="padding: 24px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                ...
                <div class="u-col u-col-33p17" style="max-width: 320px;min-width: 300px;display: table-cell;vertical-align: top;">
                    <div style="background-color: #054169;width: 100% !important;">
                        <div style="padding: 2px 35px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                            <table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                <tbody>
                                    <tr>
                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:92px 0px 20px;font-family:'Open Sans',sans-serif;" align="left">
                                            <div class="v-text-align" style="color: #ffffff; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                ...
                                                <p style="font-size: 14px; line-height: 140%; text-align: right;"><span style="font-size: 26px; line-height: 36.4px;"><strong><span style="line-height: 36.4px; font-size: 40px;">{{ __('invoice_item.currency') }}{{ number_format($invoice->getPaidAmount(), 2) }} </span></strong></span></p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
    ...
    <div class="row">
        <div class="col-sm-12 mt-5 text-center">
            <h1 class="custom-h1" id="cursive-handwriting">{{ __('common.thank_you') }}.</h1>
        </div>
    </div>
    <br>
    <a href="{{ URL::previous() }}" class="btn btn-light border mt-3" role="button">{{ __('common.back_to_previous') }}</a>
