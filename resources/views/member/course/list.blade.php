...
@section('notification')
    @if(!$isPOV)
        @component('member.shared.notification.notification-message')
        @slot('text') Hi, {{Auth::user()->getName()}}. Please register a Mplus account using this <a href="{{ route('web.register.referral') }}" target="_blank">link</a>, 
        our team will verify your account in 3 working days. You can view our course once your account is activated. @endslot
        @endcomponent
    @endif
@endsection
