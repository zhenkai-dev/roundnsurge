...
@section('form')
    ...
    @component('member.shared.form.form-header-component', ['module' => \App\Member::class])
        @slot('addNewUrl') {{ route('member.member.create') }}  @endslot
    @endcomponent
    ...
    <div class="tab-content">
        <div class="tab-pane fade show active" id="detail" role="tabpanel" aria-labelledby="detail-tab">
            ...
            <form class="form-horizontal form-validation" action="{{ is_create() ? route('member.member.store') : route('member.member.update', $member->getId()) }}" method="post" enctype="multipart/form-data">
                @if (is_edit())
                    {{ method_field('PATCH') }}
                @endif
                ...
                @if (is_edit())
                    @if ($member->getAddedBy())
                        @component('member.shared.form.form-group-text')
        ...
        @if (is_edit())
            ...
            <form class="form-horizontal form-validation" action="{{ route('member.member.address.update', $member->getId()) }}" method="post" enctype="multipart/form-data">
                @if (is_edit())
                    {{ method_field('PATCH') }}
                @endif
