...
use App\Service\Member\NewsService;
...
class NewsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('member.news.list', compact('title', 'newsList'));
    }
    ...
    public function create()
    {
        ...
        return view('member.news.form', compact('title', 'news'));
    }
    ...
    public function edit(News $news)
    {
        ...
        return view('member.news.form', compact('title', 'news', 'newsTranslation', 'friendlyUrl'));
    }
