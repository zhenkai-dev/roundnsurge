...
use App\Service\Member\PackageService;
...
class PackageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('member.package.list', compact('title', 'packages'));
    }
    ...
    public function edit(Package $package)
    {
        ...
        return view('member.package.form', compact('title', 'package', 'packageTranslation', 'friendlyUrl'));
    }
