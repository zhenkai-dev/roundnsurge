...
use App\Service\Member\BannerService;
...
class BannerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('member.banner.list', compact('title', 'banners'));
    }
    ...
    public function create()
    {
        ...
        return view('member.banner.form', compact('title', 'banner'));
    }
    ...
    public function edit(Banner $banner)
    {
        ...
        return view('member.banner.form', compact('title', 'banner', 'bannerTranslation'));
    }
