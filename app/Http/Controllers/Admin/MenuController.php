...
class MenuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.menu.list.list', compact('title', 'menus'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.menu.form', compact('title', 'menu'));
    }
    ...
    public function edit(Menu $menu)
    {
        ...
        return view('admin.menu.form', compact('title', 'menu', 'menuTranslation'));
    }
