...
class PageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.page.list', compact('title', 'pages'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.page.form', compact('title', 'page'));
    }
    ...
    public function edit(Page $page)
    {
        ...
        return view('admin.page.form', compact('title', 'page', 'pageTranslation', 'friendlyUrl'));
    }
